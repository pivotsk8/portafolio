    ...
    <v-container fluid>
        ...
        <v-row>
          <v-col cols="5">
            <div style="position: relative" class="mt-16">
              ...
              <h1 class="text-white">Soy Rami</h1>
              <span class="text-grey">Full Stack Developer</span>
              <br />
              <v-btn title dark class="text-yellow mt-8" variant="outlined">Contactame</v-btn>
            </div>
          </v-col>
          <v-col cols="2">
            <div style="
      ...
      <div class="text-center mt-4">
        ...
        <div style="
                                                                ...
                                                                margin:0 auto;
                                                                ">
          <v-slider v-model="slider2" color="green" label="track-color"></v-slider>
        </div>
      </div>
      <v-col cols="12" class="padd" id="portafolio">
        <div class="first" id="project">
          <v-row>
            <v-col cols="12">
              <div class="child">
                <v-btn icon="fas fa-laptop" color="#FBDF7E" class="text-white" />
                <h3 class="ml-3 mt-4">Web Design</h3>
                <p class="text-grey ml-3 mt-4 text-caption">
                  Lorem, ipsum dolor sit <br />
                  Fugiat labore quidem amet , <br />
                  deserunt dolorum.
                </p>
              </div>
              <div class="child">
                <v-btn icon="fas fa-mobile-alt" color="#FBDF7E" class="text-white" />
                <h3 class="ml-3 mt-4">App Desing</h3>
                <p class="text-grey ml-3 mt-4 text-caption">
                  Lorem, ipsum dolor sit <br />
                  Fugiat labore quidem amet , <br />
                  deserunt dolorum.
              ...
              <div class="child">
                <v-btn icon="fas fa-camera" color="#FBDF7E" class="text-white" />
      ...
      <v-col cols="12" sm="12" id="service">
        <div class="d-flex justify-center mb-6">
          ...
          <v-btn class="mr-2" variant="tonal">From Desing</v-btn>
          <v-btn class="mr-2" variant="tonal">Photograpjy</v-btn>
          <v-btn variant="tonal">Ilustration</v-btn>
        </div>
      </v-col>
          ...
          <v-row>
            <v-col cols="12" sm="4">
              <v-card class="mx-auto" max-width="344" height="">
                ...
                <v-card-subtitle>By AAE IdeaPro | 06 sep 2023</v-card-subtitle>
                <v-card-texte>
        ...
        <v-row>
          <v-col cols="12" sm="4">
            <div class="child">
              ...
              <br />
              <span class="text-caption">Your Street SYO, Yout Area Dream</span>
              <br />
              <v-btn icon="fas fa-phone-alt" color="" class="mt-10" variant="outlined">
              </v-btn>
              <br />
              <span class="text-caption">0025-647</span> <br />
              <span class="text-caption">0025-647</span> <br />
              <v-btn icon="fas fa-envelope" color="" class="mt-10" variant="outlined">
              </v-btn>
              <br />
              <span class="text-caption">the_pivotsk8@hotmail.com</span> <br />
            </div>
          </v-col>
          <v-col cols="12" sm="8">
            <h1 class="mt-8">Send your message</h1>
            <v-divider />
            <span class="text-caption">Lorem ipsum dolor sit amet consectetur, adipisicing elit. Laborum porro ratione
              adipisci praesentium aliquam reprehenderit vero quia soluta dolore? Ratione esse sit, laboriosam
              consequuntur repellat ea non modi maxime iusto?
            </span>
            <v-row class="mt-10">
              <v-col cols="12" sm="6">
